#include "../include/entidades/VacinaPerecivel.hpp"
...
json VacinaPerecivel::toJson() const {
    json j = ProdutoBiologico::toJson();
    j["dataValidade"] = this->getDataValidade();
    j["requisitoArmazenamento"] = this->getRequisitoArmazenamento();
    j["temperaturaMinima"] = this->getTemperaturaMinima();
    j["temperaturaMaxima"] = this->getTemperaturaMaxima();
    return j;
}
